...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative bg-zinc-950 py-24 md:py-32 px-4 border-b border-zinc-800 overflow-hidden">
      ...
      <section className="py-16 md:py-24 px-3 sm:px-4 bg-zinc-950">
