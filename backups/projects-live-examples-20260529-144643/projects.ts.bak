...
export const projects: Project[] = [
  {
    ...
    titleTr: "Kurumsal Web Sitesi / Marketing Site Template",
    ...
    shortDescriptionTr: "Hizmetler, referanslar, iletişim akışı ve müşteri talebi toplama için modern kurumsal web sitesi yapısı.",
  ...
  },
  {
    ...
    shortDescriptionTr: "Ürün listeleme, sepet, sipariş yönetimi, admin panel ve online ödeme altyapısı içerebilen e-ticaret sistemi.",
  ...
  },
  {
    ...
    titleTr: "Ürün Katalog / WhatsApp Sipariş Sitesi",
    ...
    shortDescriptionTr: "Müşterilerin ürünleri inceleyip WhatsApp üzerinden sipariş başlatabildiği ürün katalog sitesi.",
  ...
  },
  {
    ...
    titleTr: "Randevu / Rezervasyon Sistemi",
    ...
    shortDescriptionTr: "Takvim, müşteri formu ve admin takibi olan hizmet işletmeleri için randevu/rezervasyon sistemi.",
  ...
  },
  {
    ...
    titleTr: "Admin Panelli İşletme Sistemi",
    ...
    shortDescriptionTr: "Müşteri, kayıt, içerik ve günlük operasyonları yönetmek için özel admin panelli işletme sistemi.",
  ...
  },
  {
    ...
    titleTr: "Landing Page / Tek Sayfalık Satış Sayfası",
    category: "Sales Page",
    ...
    shortDescriptionTr: "Kampanya, hizmet, ürün tanıtımı ve talep toplama için odaklı tek sayfalık satış sayfası.",
  ...
  },
  {
    ...
    titleTr: "Cloud Dosya Yönetim Platformu",
    ...
    shortDescriptionTr: "Şirket içi dosya yükleme, klasörleme, kullanıcı yetkileri ve işlem geçmişi bulunan dosya yönetim sistemi.",
  ...
  },
  {
    ...
    titleTr: "Görev Yönetimi Sistemi",
    ...
    shortDescriptionTr: "Görev oluşturma, durum takibi, e-posta hatırlatma, raporlama ve PDF çıktısı içeren iş takip sistemi.",
  ...
  },
  {
    ...
    shortDescriptionTr: "Hata kayıtları, loglar ve sistem olaylarını takip etmek için hazırlanmış analiz ve raporlama paneli.",
  ...
  },
  {
    ...
    titleTr: "Video Analiz Platformu",
    ...
    shortDescriptionTr: "Video yükleme, analiz sonucu görüntüleme, raporlama ve dashboard mantığı olan medya analiz sistemi.",
